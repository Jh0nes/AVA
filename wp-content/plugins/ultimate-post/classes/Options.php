    ...
    public static function get_recommended_themes(){
        $recommended_themes = array(
            'coblog' => array(
                'name'  => 'Coblog',
                'slug'  => 'coblog',
                'url'   => 'https://github.com/wpxpo/coblog',
    ...
    public static function get_support_data() {
        ...
        $html .= '<div class="ultp-admin-sidebar">';
            ...
            $html .= '<div class="ultp-admin-card ultp-sidebar-card">';
                ...
                $html .= '<a class="button button-success" target="_blank" href="https://github.com/wpxpo/coblog">'.__('Free Download', 'ultimate-post').'</a>';
        ...
        <div class="ultp-option-body">
            <div class="ultp-setting-header">
                <div class="ultp-setting-header-info">
                    <h1>
                        <?php _e('Welcome to <strong>Gutenberg Post Blocks</strong> - Version', 'ultimate-post'); ?><span> 1.1.2</span>
                    </h1>
                        ...
                        <div class="ultp-tab-content"><!-- #Video Tutorial -->
                            <div class="ultp-video-tutorials">
                                ...
                                <div class="ultp-video-tutorial">
                                    ...
                                    <h4>How to use advaced query builder</h4>
                                </div>
                                <div class="ultp-video-tutorial">
                                ...
                                <div class="ultp-video-tutorial">
                                    ...
                                    <h4>How to use Advanced Pagination</h4>
                                </div>
                                <div class="ultp-video-tutorial">
                                    ...
                                    <h4>How to use Pre-made Blocks</h4>
                                </div>
                                <div class="ultp-video-tutorial">
                                    ...
                                    <h4>How to use Image Overlay</h4>
                                </div>
                                <div class="ultp-video-tutorial">

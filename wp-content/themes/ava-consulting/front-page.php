		...
		<main id="main" class="site-main container">
			<div class="row  my-5">
				...
				<div class="col-lg-6 col-12 d-none d-lg-block">
					...
					<img class="shaded img-fluid" src="wp-content/themes/ava-consulting/assets/img/raw/business-charts-data-document.png" class="img-fluid" alt="Business Charts">
				</div>
			</div>
			...
			<div class="row my-5 py-5 bg-dark-gradient">
				<div class="col-6 p-5">
					...
					<img class="svg-icon my-5" src="wp-content/themes/ava-consulting/assets/img/raw/calendar-icon.svg" class="img-fluid customer-logo" alt="Agendar Reunião - Consultoria Financeira">
				...
				<div class="col-6">
					<div class="col-6">
						<div class="shade bg-info"></div>
						<img class="shaded" src="wp-content/themes/ava-consulting/assets/img/raw/contract-signing.png" class="img-fluid" alt="Business Charts">
					</div>
				</div>
			</div>
			...
			<div class="row my-5 py-2">
				...
				<div class="col-3">
					<div class="shade bg-info"></div>
					<img class="shaded" src="wp-content/themes/ava-consulting/assets/img/raw/blog-post-image.png" class="img-fluid" alt="Business Charts">
				</div>
				<div class="col-3">
					<div class="shade bg-info"></div>
					<img class="shaded" src="wp-content/themes/ava-consulting/assets/img/raw/blog-post-image.png" class="img-fluid" alt="Business Charts">
